...
namespace NS_9tasks_p2 {
    ...
    void get_states_num(mt24* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt24::iterator itr24 = (*generated).begin(); itr24 != (*generated).end(); itr24++) {
    ...
    bool find_dominating_state(const state& s, mt24* visitedStates) {
        ...
        for (int i24 = 0; i24 < keysNum_pj; i24++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i24]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i24], keysNum_lj, bKeys_lj);
                
                for (int i23 = 0; i23 < keysNum_lj; i23++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i24]]).find((*bKeys_lj)[i23]) != ((*visitedStates)[(*bKeys_pj)[i24]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i23], keysNum_p1, bKeys_p1);
                        
                        for (int i22 = 0; i22 < keysNum_p1; i22++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]]).find((*bKeys_p1)[i22]) != (((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i23], (*bKeys_p1)[i22], keysNum_p2, bKeys_p2);
                                for (int i21 = 0; i21 < keysNum_p2; i21++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]])[(*bKeys_p1)[i22]]).find((*bKeys_p2)[i21]) != (((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]])[(*bKeys_p1)[i22]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt20::reverse_iterator itr20 = ((((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]])[(*bKeys_p1)[i22]])[(*bKeys_p2)[i21]].rbegin(); itr20 != ((((*visitedStates)[(*bKeys_pj)[i24]])[(*bKeys_lj)[i23]])[(*bKeys_p1)[i22]])[(*bKeys_p2)[i21]].rend(); itr20++) {
    ...
    void remove_dominated_states(const state& s, mt24* visitedStates) {
        ...
        for (int i24 = 0; i24 < keysNum_pj2; i24++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i24]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i24], keysNum_lj2, bKeys_lj2);
                
                for (int i23 = 0; i23 < keysNum_lj2; i23++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i24]]).find((*bKeys_lj2)[i23]) != ((*visitedStates)[(*bKeys_pj2)[i24]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i23], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i22 = 0; i22 < keysNum_p1_2; i22++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i24]][(*bKeys_lj2)[i23]]).find((*bKeys_p1_2)[i22]) != ((*visitedStates)[(*bKeys_pj2)[i24]][(*bKeys_lj2)[i23]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i23], (*bKeys_p1_2)[i22], keysNum_p2_2, bKeys_p2_2);
                                for (int i21 = 0; i21 < keysNum_p2_2; i21++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i24]][(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]].find((*bKeys_p2_2)[i21]) != ((*visitedStates)[(*bKeys_pj2)[i24]][(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]].end()) {
                                        
                                        for (mt20::iterator itr20 = (((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]]))[(*bKeys_p2_2)[i21]].begin(); itr20 != (((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]]))[(*bKeys_p2_2)[i21]].end();) {
                                            ...
                                            if (itr20->first > s.sumCs) break;
                                                ...
                                                if ((itr20->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]]))[(*bKeys_p2_2)[i21]].erase(itr20++);
                                                else ++itr20;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]])[(*bKeys_p2_2)[i21]].empty()) (((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]].erase((*bKeys_p2_2)[i21]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]])[(*bKeys_p1_2)[i22]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]]).erase((*bKeys_p1_2)[i22]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i24]])[(*bKeys_lj2)[i23]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i24]]).erase((*bKeys_lj2)[i23]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i24]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i24]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt24* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]] = true;
    }
    ...
    bool update_map(const state& s, mt24* visitedStates, const bool removeStates) {
...
} // end of namespace NS_9tasks_p2





bool test_9th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_9tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_9tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_9tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_9tasks_p2::visitedStatesNum;
