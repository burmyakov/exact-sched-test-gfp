...
namespace NS_7tasks_p2 {
    ...
    void get_states_num(mt20* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt20::iterator itr20 = (*generated).begin(); itr20 != (*generated).end(); itr20++) {
    ...
    bool find_dominating_state(const state& s, mt20* visitedStates) {
        ...
        for (int i20 = 0; i20 < keysNum_pj; i20++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i20]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i20], keysNum_lj, bKeys_lj);
                for (int i19 = 0; i19 < keysNum_lj; i19++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj)[i20]]).find((*bKeys_lj)[i19]) != ((*visitedStates)[(*bKeys_pj)[i20]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i19], keysNum_p1, bKeys_p1);
                        for (int i18 = 0; i18 < keysNum_p1; i18++) { // p1 keys
                            
                            if ((((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]]).find((*bKeys_p1)[i18]) != (((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i19], (*bKeys_p1)[i18], keysNum_p2, bKeys_p2);
                                for (int i17 = 0; i17 < keysNum_p2; i17++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]])[(*bKeys_p1)[i18]]).find((*bKeys_p2)[i17]) != (((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]])[(*bKeys_p1)[i18]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt16::reverse_iterator itr16 = (((((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]])[(*bKeys_p1)[i18]]))[(*bKeys_p2)[i17]].rbegin(); itr16 != (((((*visitedStates)[(*bKeys_pj)[i20]])[(*bKeys_lj)[i19]])[(*bKeys_p1)[i18]]))[(*bKeys_p2)[i17]].rend(); itr16++) {
    ...
    void remove_dominated_states(const state& s, mt20* visitedStates) {
        ...
        for (int i20 = 0; i20 < keysNum_pj2; i20++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i20]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i20], keysNum_lj2, bKeys_lj2);
                
                for (int i19 = 0; i19 < keysNum_lj2; i19++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj2)[i20]]).find((*bKeys_lj2)[i19]) != ((*visitedStates)[(*bKeys_pj2)[i20]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i19], keysNum_p1_2, bKeys_p1_2);
                        for (int i18 = 0; i18 < keysNum_p1_2; i18++) { // p1 key
                            
                            if (((*visitedStates)[(*bKeys_pj2)[i20]][(*bKeys_lj2)[i19]]).find((*bKeys_p1_2)[i18]) != ((*visitedStates)[(*bKeys_pj2)[i20]][(*bKeys_lj2)[i19]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i19], (*bKeys_p1_2)[i18], keysNum_p2_2, bKeys_p2_2);
                                for (int i17 = 0; i17 < keysNum_p2_2; i17++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i20]][(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]].find((*bKeys_p2_2)[i17]) != ((*visitedStates)[(*bKeys_pj2)[i20]][(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]].end()) {
                                        
                                        for (mt16::iterator itr16 = (((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]]))[(*bKeys_p2_2)[i17]].begin(); itr16 != (((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]]))[(*bKeys_p2_2)[i17]].end();) {
                                            ...
                                            if (itr16->first > s.sumCs) break;
                                                ...
                                                if ((itr16->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]]))[(*bKeys_p2_2)[i17]].erase(itr16++);
                                                else ++itr16;
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]])[(*bKeys_p2_2)[i17]].empty()) (((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]].erase((*bKeys_p2_2)[i17]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]])[(*bKeys_p1_2)[i18]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]]).erase((*bKeys_p1_2)[i18]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i20]])[(*bKeys_lj2)[i19]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i20]]).erase((*bKeys_lj2)[i19]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i20]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i20]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt20* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]] = true;
    }
    ...
    bool update_map(const state& s, mt20* visitedStates, const bool removeStates) {
...
} // end of namespace NS_7tasks_p2





bool test_7th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_7tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_7tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_7tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_7tasks_p2::visitedStatesNum;
