...
namespace NS_3tasks_p2 {
    ...
    void get_states_num(mt12* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        
        for (mt12::iterator itr12 = (*generated).begin(); itr12 != (*generated).end(); itr12++) {
    ...
    bool find_dominating_state(const state& s, mt12* visitedStates) {
        ...
        for (int i12 = 0; i12 < keysNum_pj; i12++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i12]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i12], keysNum_lj, bKeys_lj);
                
                for (int i11 = 0; i11 < keysNum_lj; i11++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i12]]).find((*bKeys_lj)[i11]) != ((*visitedStates)[(*bKeys_pj)[i12]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i11], keysNum_p1, bKeys_p1);
                        
                        for (int i10 = 0; i10 < keysNum_p1; i10++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]]).find((*bKeys_p1)[i10]) != (((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i11], (*bKeys_p1)[i10], keysNum_p2, bKeys_p2);
                                for (int i9 = 0; i9 < keysNum_p2; i9++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]])[(*bKeys_p1)[i10]]).find((*bKeys_p2)[i9]) != (((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]])[(*bKeys_p1)[i10]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt8::reverse_iterator itr8 = ((((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]])[(*bKeys_p1)[i10]])[(*bKeys_p2)[i9]].rbegin(); itr8 != ((((*visitedStates)[(*bKeys_pj)[i12]])[(*bKeys_lj)[i11]])[(*bKeys_p1)[i10]])[(*bKeys_p2)[i9]].rend(); itr8++) {
    ...
    void remove_dominated_states(const state& s, mt12* visitedStates) {
        ...
        for (int i12 = 0; i12 < keysNum_pj2; i12++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i12]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i12], keysNum_lj2, bKeys_lj2);
                
                for (int i11 = 0; i11 < keysNum_lj2; i11++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i12]]).find((*bKeys_lj2)[i11]) != ((*visitedStates)[(*bKeys_pj2)[i12]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i11], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i10 = 0; i10 < keysNum_p1_2; i10++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i12]][(*bKeys_lj2)[i11]]).find((*bKeys_p1_2)[i10]) != ((*visitedStates)[(*bKeys_pj2)[i12]][(*bKeys_lj2)[i11]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i11], (*bKeys_p1_2)[i10], keysNum_p2_2, bKeys_p2_2);
                                for (int i9 = 0; i9 < keysNum_p2_2; i9++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i12]][(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]].find((*bKeys_p2_2)[i9]) != ((*visitedStates)[(*bKeys_pj2)[i12]][(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]].end()) {
                                        
                                        for (mt8::iterator itr8 = ((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]])[(*bKeys_p2_2)[i9]].begin(); itr8 != ((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]])[(*bKeys_p2_2)[i9]].end();) {
                                            ...
                                            if (itr8->first > s.sumCs) break;
                                                ...
                                                if ((itr8->second).empty()) ((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]])[(*bKeys_p2_2)[i9]].erase(itr8++);
                                                else ++itr8;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]])[(*bKeys_p2_2)[i9]].empty()) (((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]].erase((*bKeys_p2_2)[i9]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]])[(*bKeys_p1_2)[i10]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]]).erase((*bKeys_p1_2)[i10]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i12]])[(*bKeys_lj2)[i11]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i12]]).erase((*bKeys_lj2)[i11]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i12]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i12]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt12* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.c[0]][s.c[1]][s.c[2]] = true;
    }
    ...
    bool update_map(const state& s, mt12* visitedStates, const bool removeStates) {
...
} // end of namespace NS_3tasks_p2





bool test_3d_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {

    NS_3tasks_p2::verbose = verbose_;

    bool schedulable = NS_3tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_3tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_3tasks_p2::visitedStatesNum;
