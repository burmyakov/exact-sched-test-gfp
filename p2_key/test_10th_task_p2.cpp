...
namespace NS_10tasks_p2 {
    ...
    void get_states_num(mt26* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt26::iterator itr26 = (*generated).begin(); itr26 != (*generated).end(); itr26++) {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt20& visitedStates20) {
        
        for (mt20::iterator itr20 = visitedStates20.begin(); itr20 != visitedStates20.end(); itr20++) {
            if (itr20->first > s.t[0]) break;
            else {
                for (mt19::iterator itr19 = (itr20->second).begin(); itr19 != (itr20->second).end(); itr19++) {
                    if (itr19->first > s.t[1]) break;
                    else {
                        for (mt18::iterator itr18 = (itr19->second).begin(); itr18 != (itr19->second).end(); itr18++) {
                            if (itr18->first > s.t[2]) break;
                            else {
                                for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                    if (itr17->first > s.t[3]) break;
                                    else {
                                        for (mt16::iterator itr16 = (itr17->second).begin(); itr16 != (itr17->second).end(); itr16++) {
                                            if (itr16->first > s.t[4]) break;
                                            else {
                                                for (mt15::iterator itr15 = (itr16->second).begin(); itr15 != (itr16->second).end(); itr15++) {
                                                    if (itr15->first > s.t[5]) break;
                                                    else {
                                                        for (mt14::iterator itr14 = (itr15->second).begin(); itr14 != (itr15->second).end(); itr14++) {
                                                            if (itr14->first > s.t[6]) break;
                                                            else {
                                                                for (mt13::iterator itr13 = (itr14->second).begin(); itr13 != (itr14->second).end(); itr13++) {
                                                                    if (itr13->first > s.t[7]) break;
                                                                    else {
                                                                        for (mt12::iterator itr12 = (itr13->second).begin(); itr12 != (itr13->second).end(); itr12++) {
                                                                            if (itr12->first > s.t[8]) break;
                                                                            else {
                                                                                for (mt11::iterator itr11 = (itr12->second).begin(); itr11 != (itr12->second).end(); itr11++) {
                                                                                    if (itr11->first > s.t[9]) break;
                                                                                    else if (find_dominating_state_c_iterations(s, itr11->second)) return true;
                                                                                }
                                                                            }
                                                                        }
                                                                    }
    ...
    bool find_dominating_state(const state& s, mt26* visitedStates) {
        ...
        for (int i26 = 0; i26 < keysNum_pj; i26++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i26]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i26], keysNum_lj, bKeys_lj);
                
                for (int i25 = 0; i25 < keysNum_lj; i25++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i26]]).find((*bKeys_lj)[i25]) != ((*visitedStates)[(*bKeys_pj)[i26]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i25], keysNum_p1, bKeys_p1);
                        
                        for (int i24 = 0; i24 < keysNum_p1; i24++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]]).find((*bKeys_p1)[i24]) != (((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i25], (*bKeys_p1)[i24], keysNum_p2, bKeys_p2);
                                for (int i23 = 0; i23 < keysNum_p2; i23++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]])[(*bKeys_p1)[i24]]).find((*bKeys_p2)[i23]) != (((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]])[(*bKeys_p1)[i24]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt22::reverse_iterator itr22 = ((((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]])[(*bKeys_p1)[i24]])[(*bKeys_p2)[i23]].rbegin(); itr22 != ((((*visitedStates)[(*bKeys_pj)[i26]])[(*bKeys_lj)[i25]])[(*bKeys_p1)[i24]])[(*bKeys_p2)[i23]].rend(); itr22++) {
                                            
                                            if (itr22->first < s.sumCs) break;
                                            else {
                                                
                                                for (mt21::iterator itr21 = (itr22->second).begin(); itr21 != (itr22->second).end(); itr21++) {
                                                    if (itr21->first > s.sumSlacks) break;
                                                    else if (find_dominating_state_p_iterations(s, itr21->second)) return true;
                                                }
                                            }
                                        }
                                    }
    ...
    void remove_dominated_states_c_iterations(const state& s, mt10& visitedStates10) {
        
        for (mt10::iterator itr10 = visitedStates10.begin(); itr10 != visitedStates10.end();) {
            if (itr10->first > s.c[0]) break;
            else {
                ...
                if ((itr10->second).empty()) (visitedStates10).erase(itr10++);
                else ++itr10;
            }
        } // itr10
    ...
    void remove_dominated_states_p_iterations(const state& s, mt20& visitedStates20) {
        
        for (mt20::reverse_iterator itr20 = visitedStates20.rbegin(); itr20 != visitedStates20.rend();) {
            if (itr20->first < s.t[0]) break;
            else {
                                                                            ...
                                                                            if (itr12->first < s.t[8]) break;
                                                                                ...
                                                                                for (mt11::reverse_iterator itr11 = (itr12->second).rbegin(); itr11 != (itr12->second).rend();) {
                                                                                    if (itr11->first < s.t[9]) break;
                                                                                        ...
                                                                                        remove_dominated_states_c_iterations(s, (itr11->second));
                ...
                if ((itr20->second).empty()) visitedStates20.erase(--(itr20.base()));
                else ++itr20;
            }
        }
    ...
    void remove_dominated_states(const state& s, mt26* visitedStates) {
        ...
        for (int i26 = 0; i26 < keysNum_pj2; i26++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i26]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i26], keysNum_lj2, bKeys_lj2);
                
                for (int i25 = 0; i25 < keysNum_lj2; i25++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i26]]).find((*bKeys_lj2)[i25]) != ((*visitedStates)[(*bKeys_pj2)[i26]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i25], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i24 = 0; i24 < keysNum_p1_2; i24++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i26]][(*bKeys_lj2)[i25]]).find((*bKeys_p1_2)[i24]) != ((*visitedStates)[(*bKeys_pj2)[i26]][(*bKeys_lj2)[i25]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i25], (*bKeys_p1_2)[i24], keysNum_p2_2, bKeys_p2_2);
                                for (int i23 = 0; i23 < keysNum_p2_2; i23++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i26]][(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]].find((*bKeys_p2_2)[i23]) != ((*visitedStates)[(*bKeys_pj2)[i26]][(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]].end()) {
                                        
                                        for (mt22::iterator itr22 = (((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]]))[(*bKeys_p2_2)[i23]].begin(); itr22 != (((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]]))[(*bKeys_p2_2)[i23]].end();) {
                                            
                                            if (itr22->first > s.sumCs) break;
                                            else {
                                                for (mt21::reverse_iterator itr21 = (itr22->second).rbegin(); itr21 != (itr22->second).rend();) {
                                                    if (itr21->first < s.sumSlacks) break;
                                                    else remove_dominated_states_p_iterations(s, itr21->second);
                                                    
                                                    if ((itr21->second).empty()) (itr22->second).erase(--(itr21.base()));
                                                    else ++itr21;
                                                }
                                                if ((itr22->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]]))[(*bKeys_p2_2)[i23]].erase(itr22++);
                                                else ++itr22;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]])[(*bKeys_p2_2)[i23]].empty()) (((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]].erase((*bKeys_p2_2)[i23]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]])[(*bKeys_p1_2)[i24]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]]).erase((*bKeys_p1_2)[i24]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i26]])[(*bKeys_lj2)[i25]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i26]]).erase((*bKeys_lj2)[i25]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i26]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i26]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt26* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]] = true;
    }
    ...
    bool update_map(const state& s, mt26* visitedStates, const bool removeStates) {
    ...
    bool populate(const unsigned short m_, const TS& ts_, const bool removeStates) {
        ...
        if (verbose) {
            ...
            cout << "Visited states with tau_10 pending: " << visitedStatesNum_withTauKpending << "  ( " << (float)((int)(visitedStatesNum_withTauKpending*10000/visitedStatesNum))/100 << " %)" << endl << endl;
        }
        
        return schedulable;
    }
} // end of namespace NS_10tasks_p2





bool test_10th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_10tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_10tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_10tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_10tasks_p2::visitedStatesNum;
