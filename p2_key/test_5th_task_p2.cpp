...
namespace NS_5tasks_p2 {
    ...
    void get_states_num(mt16* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt16::iterator itr16 = (*generated).begin(); itr16 != (*generated).end(); itr16++) {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt10& visitedStates10) {
        ...
        for (mt10::iterator itr10 = visitedStates10.begin(); itr10 != visitedStates10.end(); itr10++) {
            ...
            if (itr10->first > s.t[0]) break;
            else {
                
                for (mt9::iterator itr9 = (itr10->second).begin(); itr9 != (itr10->second).end(); itr9++) {
                    if (itr9->first > s.t[1]) break;
                    else {
                        for (mt8::iterator itr8 = (itr9->second).begin(); itr8 != (itr9->second).end(); itr8++) {
                            if (itr8->first > s.t[2]) break;
                            else {
                                
                                for (mt7::iterator itr7 = (itr8->second).begin(); itr7 != (itr8->second).end(); itr7++) {
                                    if (itr7->first > s.t[3]) break;
                                    else {
                                        for (mt6::iterator itr6 = (itr7->second).begin(); itr6 != (itr7->second).end(); itr6++) {
                                            if (itr6->first > s.t[4]) break;
    ...
    bool find_dominating_state(const state& s, mt16* visitedStates) {
        ...
        for (int i16 = 0; i16 < keysNum_pj; i16++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i16]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i16], keysNum_lj, bKeys_lj);
                
                for (int i15 = 0; i15 < keysNum_lj; i15++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i16]]).find((*bKeys_lj)[i15]) != ((*visitedStates)[(*bKeys_pj)[i16]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i15], keysNum_p1, bKeys_p1);
                        
                        for (int i14 = 0; i14 < keysNum_p1; i14++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]]).find((*bKeys_p1)[i14]) != (((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i15], (*bKeys_p1)[i14], keysNum_p2, bKeys_p2);
                                for (int i13 = 0; i13 < keysNum_p2; i13++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]])[(*bKeys_p1)[i14]]).find((*bKeys_p2)[i13]) != (((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]])[(*bKeys_p1)[i14]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt12::reverse_iterator itr12 = ((((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]])[(*bKeys_p1)[i14]])[(*bKeys_p2)[i13]].rbegin(); itr12 != ((((*visitedStates)[(*bKeys_pj)[i16]])[(*bKeys_lj)[i15]])[(*bKeys_p1)[i14]])[(*bKeys_p2)[i13]].rend(); itr12++) {
    ...
    void remove_dominated_states(const state& s, mt16* visitedStates) {
        ...
        for (int i16 = 0; i16 < keysNum_pj2; i16++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i16]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i16], keysNum_lj2, bKeys_lj2);
                
                for (int i15 = 0; i15 < keysNum_lj2; i15++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i16]]).find((*bKeys_lj2)[i15]) != ((*visitedStates)[(*bKeys_pj2)[i16]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i15], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i14 = 0; i14 < keysNum_p1_2; i14++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i16]][(*bKeys_lj2)[i15]]).find((*bKeys_p1_2)[i14]) != ((*visitedStates)[(*bKeys_pj2)[i16]][(*bKeys_lj2)[i15]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i15], (*bKeys_p1_2)[i14], keysNum_p2_2, bKeys_p2_2);
                                for (int i13 = 0; i13 < keysNum_p2_2; i13++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i16]][(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]].find((*bKeys_p2_2)[i13]) != ((*visitedStates)[(*bKeys_pj2)[i16]][(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]].end()) {
                                        
                                        for (mt12::iterator itr12 = ((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]])[(*bKeys_p2_2)[i13]].begin(); itr12 != ((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]])[(*bKeys_p2_2)[i13]].end();) {
                                            ...
                                            if (itr12->first > s.sumCs) break;
                                                ...
                                                if ((itr12->second).empty()) ((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]])[(*bKeys_p2_2)[i13]].erase(itr12++);
                                                else ++itr12;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]])[(*bKeys_p2_2)[i13]].empty()) (((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]].erase((*bKeys_p2_2)[i13]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]])[(*bKeys_p1_2)[i14]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]]).erase((*bKeys_p1_2)[i14]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i16]])[(*bKeys_lj2)[i15]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i16]]).erase((*bKeys_lj2)[i15]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i16]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i16]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt16* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]] = true;
    }
    ...
    bool update_map(const state& s, mt16* visitedStates, const bool removeStates) {
...
} // end of namespace NS_5tasks_p2





bool test_5th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {

    NS_5tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_5tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_5tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_5tasks_p2::visitedStatesNum;
