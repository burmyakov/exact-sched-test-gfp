...
namespace NS_14tasks_p2 {
    ...
    void get_states_num(mt34* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt34::iterator itr34 = (*generated).begin(); itr34 != (*generated).end(); itr34++) {
    ...
    bool find_dominating_state(const state& s, mt34* visitedStates) {
        ...
        for (int i34 = 0; i34 < keysNum_pj; i34++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i34]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i34], keysNum_lj, bKeys_lj);
                
                for (int i33 = 0; i33 < keysNum_lj; i33++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i34]]).find((*bKeys_lj)[i33]) != ((*visitedStates)[(*bKeys_pj)[i34]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i33], keysNum_p1, bKeys_p1);
                        
                        for (int i32 = 0; i32 < keysNum_p1; i32++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]]).find((*bKeys_p1)[i32]) != (((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i33], (*bKeys_p1)[i32], keysNum_p2, bKeys_p2);
                                for (int i31 = 0; i31 < keysNum_p2; i31++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]])[(*bKeys_p1)[i32]]).find((*bKeys_p2)[i31]) != (((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]])[(*bKeys_p1)[i32]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt30::reverse_iterator itr30 = ((((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]])[(*bKeys_p1)[i32]])[(*bKeys_p2)[i31]].rbegin(); itr30 != ((((*visitedStates)[(*bKeys_pj)[i34]])[(*bKeys_lj)[i33]])[(*bKeys_p1)[i32]])[(*bKeys_p2)[i31]].rend(); itr30++) {
    ...
    void remove_dominated_states(const state& s, mt34* visitedStates) {
        ...
        for (int i34 = 0; i34 < keysNum_pj2; i34++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i34]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i34], keysNum_lj2, bKeys_lj2);
                
                for (int i33 = 0; i33 < keysNum_lj2; i33++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i34]]).find((*bKeys_lj2)[i33]) != ((*visitedStates)[(*bKeys_pj2)[i34]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i33], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i32 = 0; i32 < keysNum_p1_2; i32++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i34]][(*bKeys_lj2)[i33]]).find((*bKeys_p1_2)[i32]) != ((*visitedStates)[(*bKeys_pj2)[i34]][(*bKeys_lj2)[i33]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i33], (*bKeys_p1_2)[i32], keysNum_p2_2, bKeys_p2_2);
                                for (int i31 = 0; i31 < keysNum_p2_2; i31++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i34]][(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]].find((*bKeys_p2_2)[i31]) != ((*visitedStates)[(*bKeys_pj2)[i34]][(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]].end()) {
                                        
                                        for (mt30::iterator itr30 = (((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]]))[(*bKeys_p2_2)[i31]].begin(); itr30 != (((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]]))[(*bKeys_p2_2)[i31]].end();) {
                                            ...
                                            if (itr30->first > s.sumCs) break;
                                                ...
                                                if ((itr30->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]]))[(*bKeys_p2_2)[i31]].erase(itr30++);
                                                else ++itr30;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]])[(*bKeys_p2_2)[i31]].empty()) (((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]].erase((*bKeys_p2_2)[i31]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]])[(*bKeys_p1_2)[i32]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]]).erase((*bKeys_p1_2)[i32]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i34]])[(*bKeys_lj2)[i33]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i34]]).erase((*bKeys_lj2)[i33]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i34]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i34]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt34* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.t[11]][s.t[12]][s.t[13]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]][s.c[12]][s.c[13]] = true;
    }
    ...
    bool update_map(const state& s, mt34* visitedStates, const bool removeStates) {
...
} // end of namespace NS_14tasks_p2





bool test_14th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_14tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_14tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_14tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_14tasks_p2::visitedStatesNum;
