...
namespace NS_12tasks_p2 {
    ...
    void get_states_num(mt30* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt30::iterator itr30 = (*generated).begin(); itr30 != (*generated).end(); itr30++) {
    ...
    bool find_dominating_state(const state& s, mt30* visitedStates) {
        ...
        for (int i30 = 0; i30 < keysNum_pj; i30++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i30]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i30], keysNum_lj, bKeys_lj);
                
                for (int i29 = 0; i29 < keysNum_lj; i29++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i30]]).find((*bKeys_lj)[i29]) != ((*visitedStates)[(*bKeys_pj)[i30]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i29], keysNum_p1, bKeys_p1);
                        
                        for (int i28 = 0; i28 < keysNum_p1; i28++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]]).find((*bKeys_p1)[i28]) != (((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i29], (*bKeys_p1)[i28], keysNum_p2, bKeys_p2);
                                for (int i27 = 0; i27 < keysNum_p2; i27++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]])[(*bKeys_p1)[i28]]).find((*bKeys_p2)[i27]) != (((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]])[(*bKeys_p1)[i28]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt26::reverse_iterator itr26 = ((((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]])[(*bKeys_p1)[i28]])[(*bKeys_p2)[i27]].rbegin(); itr26 != ((((*visitedStates)[(*bKeys_pj)[i30]])[(*bKeys_lj)[i29]])[(*bKeys_p1)[i28]])[(*bKeys_p2)[i27]].rend(); itr26++) {
    ...
    void remove_dominated_states(const state& s, mt30* visitedStates) {
        ...
        for (int i30 = 0; i30 < keysNum_pj2; i30++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i30]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i30], keysNum_lj2, bKeys_lj2);
                
                for (int i29 = 0; i29 < keysNum_lj2; i29++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i30]]).find((*bKeys_lj2)[i29]) != ((*visitedStates)[(*bKeys_pj2)[i30]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i29], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i28 = 0; i28 < keysNum_p1_2; i28++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i30]][(*bKeys_lj2)[i29]]).find((*bKeys_p1_2)[i28]) != ((*visitedStates)[(*bKeys_pj2)[i30]][(*bKeys_lj2)[i29]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i29], (*bKeys_p1_2)[i28], keysNum_p2_2, bKeys_p2_2);
                                for (int i27 = 0; i27 < keysNum_p2_2; i27++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i30]][(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]].find((*bKeys_p2_2)[i27]) != ((*visitedStates)[(*bKeys_pj2)[i30]][(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]].end()) {
                                        
                                        for (mt26::iterator itr26 = (((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]]))[(*bKeys_p2_2)[i27]].begin(); itr26 != (((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]]))[(*bKeys_p2_2)[i27]].end();) {
                                            ...
                                            if (itr26->first > s.sumCs) break;
                                                ...
                                                if ((itr26->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]]))[(*bKeys_p2_2)[i27]].erase(itr26++);
                                                else ++itr26;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]])[(*bKeys_p2_2)[i27]].empty()) (((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]].erase((*bKeys_p2_2)[i27]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]])[(*bKeys_p1_2)[i28]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]]).erase((*bKeys_p1_2)[i28]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i30]])[(*bKeys_lj2)[i29]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i30]]).erase((*bKeys_lj2)[i29]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i30]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i30]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt30* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.t[11]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]] = true;
    }
    ...
    bool update_map(const state& s, mt30* visitedStates, const bool removeStates) {
...
} // end of namespace NS_12tasks_p2





bool test_12th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_12tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_12tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_12tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_12tasks_p2::visitedStatesNum;
