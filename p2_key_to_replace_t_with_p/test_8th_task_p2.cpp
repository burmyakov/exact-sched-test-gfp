...
namespace NS_8tasks_p2 {
    ...
    void get_states_num(mt22* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
    ...
    bool find_dominating_state(const state& s, mt22* visitedStates) {
                            ...
                            if ((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]]).find((*bKeys_p1)[i20]) != (((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]]).end()) {
                                ...
                                for (int i19 = 0; i19 < keysNum_p2; i19++) {
                                    ...
                                    if (((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]]).find((*bKeys_p2)[i19]) != (((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]].end()) {
                                        ...
                                        for (mt18::reverse_iterator itr18 = ((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]])[(*bKeys_p2)[i19]].rbegin(); itr18 != ((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]])[(*bKeys_p2)[i19]].rend(); itr18++) {
    ...
    void remove_dominated_states(const state& s, mt22* visitedStates) {
                            ...
                            if (((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]]).find((*bKeys_p1_2)[i20]) != ((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]]).end()) {
                                ...
                                for (int i19 = 0; i19 < keysNum_p2_2; i19++) {
                                    ...
                                    if (((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]].find((*bKeys_p2_2)[i19]) != ((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]].end()) {
                                        ...
                                        for (mt18::iterator itr18 = (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]]))[(*bKeys_p2_2)[i19]].begin(); itr18 != (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]]))[(*bKeys_p2_2)[i19]].end();) {
                                            ...
                                            if (itr18->first > s.sumCs) break;
                                                ...
                                                if ((itr18->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]]))[(*bKeys_p2_2)[i19]].erase(itr18++);
                                                else ++itr18;
                                            }
                                        }
    ...
    void add_state_to_map(const state& s, mt22* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]] = true;
    }
    ...
    bool update_map(const state& s, mt22* visitedStates, const bool removeStates) {
...
} // end of namespace NS_8tasks_p2





bool test_8th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_8tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_8tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_8tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_8tasks_p2::visitedStatesNum;
