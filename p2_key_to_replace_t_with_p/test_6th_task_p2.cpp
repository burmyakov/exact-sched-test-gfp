...
namespace NS_6tasks_p2 {
    ...
    void get_states_num(mt18* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt18::iterator itr18 = (*generated).begin(); itr18 != (*generated).end(); itr18++) {
    ...
    bool find_dominating_state(const state& s, mt18* visitedStates) {
        ...
        for (int i18 = 0; i18 < keysNum_pj; i18++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i18]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i18], keysNum_lj, bKeys_lj);
                
                for (int i17 = 0; i17 < keysNum_lj; i17++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i18]]).find((*bKeys_lj)[i17]) != ((*visitedStates)[(*bKeys_pj)[i18]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i17], keysNum_p1, bKeys_p1);
                        
                        for (int i16 = 0; i16 < keysNum_p1; i16++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]]).find((*bKeys_p1)[i16]) != (((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i17], (*bKeys_p1)[i16], keysNum_p2, bKeys_p2);
                                for (int i15 = 0; i15 < keysNum_p2; i15++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]])[(*bKeys_p1)[i16]]).find((*bKeys_p2)[i15]) != (((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]])[(*bKeys_p1)[i16]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt14::reverse_iterator itr14 = ((((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]])[(*bKeys_p1)[i16]])[(*bKeys_p2)[i15]].rbegin(); itr14 != ((((*visitedStates)[(*bKeys_pj)[i18]])[(*bKeys_lj)[i17]])[(*bKeys_p1)[i16]])[(*bKeys_p2)[i15]].rend(); itr14++) {
    ...
    void remove_dominated_states(const state& s, mt18* visitedStates) {
        ...
        for (int i18 = 0; i18 < keysNum_pj2; i18++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i18]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i18], keysNum_lj2, bKeys_lj2);
                
                for (int i17 = 0; i17 < keysNum_lj2; i17++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i18]]).find((*bKeys_lj2)[i17]) != ((*visitedStates)[(*bKeys_pj2)[i18]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i17], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i16 = 0; i16 < keysNum_p1_2; i16++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i18]][(*bKeys_lj2)[i17]]).find((*bKeys_p1_2)[i16]) != ((*visitedStates)[(*bKeys_pj2)[i18]][(*bKeys_lj2)[i17]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i17], (*bKeys_p1_2)[i16], keysNum_p2_2, bKeys_p2_2);
                                for (int i15 = 0; i15 < keysNum_p2_2; i15++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i18]][(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]].find((*bKeys_p2_2)[i15]) != ((*visitedStates)[(*bKeys_pj2)[i18]][(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]].end()) {
                                        
                                        for (mt14::iterator itr14 = ((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]])[(*bKeys_p2_2)[i15]].begin(); itr14 != ((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]])[(*bKeys_p2_2)[i15]].end();) {
                                            ...
                                            if (itr14->first > s.sumCs) break;
                                                ...
                                                if ((itr14->second).empty()) ((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]])[(*bKeys_p2_2)[i15]].erase(itr14++);
                                                else ++itr14;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]])[(*bKeys_p2_2)[i15]].empty()) (((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]].erase((*bKeys_p2_2)[i15]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]])[(*bKeys_p1_2)[i16]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]]).erase((*bKeys_p1_2)[i16]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i18]])[(*bKeys_lj2)[i17]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i18]]).erase((*bKeys_lj2)[i17]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i18]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i18]);
            }
    ...
    void add_state_to_map(const state& s, mt18* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]] = true;
    }
    ...
    bool update_map(const state& s, mt18* visitedStates, const bool removeStates) {
...
} // end of namespace NS_6tasks_p2





bool test_6th_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_6tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_6tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_6tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_6tasks_p2::visitedStatesNum;
