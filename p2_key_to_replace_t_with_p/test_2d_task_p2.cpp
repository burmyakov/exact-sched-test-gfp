...
namespace NS_2tasks_p2 {
    ...
    void get_states_num(mt10* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt10::iterator itr10 = (*generated).begin(); itr10 != (*generated).end(); itr10++) {
    ...
    bool find_dominating_state(const state& s, mt10* visitedStates) {
        ...
        for (int i10 = 0; i10 < keysNum_pj; i10++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i10]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i10], keysNum_lj, bKeys_lj);
                
                for (int i9 = 0; i9 < keysNum_lj; i9++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i10]]).find((*bKeys_lj)[i9]) != ((*visitedStates)[(*bKeys_pj)[i10]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i9], keysNum_p1, bKeys_p1);
                        for (int i8 = 0; i8 < keysNum_p1; i8++) { // p1 keys
                            
                            if ((((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]]).find((*bKeys_p1)[i8]) != (((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i9], (*bKeys_p1)[i8], keysNum_p2, bKeys_p2);
                                for (int i7 = 0; i7 < keysNum_p2; i7++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]])[(*bKeys_p1)[i8]]).find((*bKeys_p2)[i7]) != (((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]])[(*bKeys_p1)[i8]].end()) {
                                        
                                        // sum of remaining execution times
                                        for (mt6::reverse_iterator itr6 = ((((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]])[(*bKeys_p1)[i8]])[(*bKeys_p2)[i7]].rbegin(); itr6 != ((((*visitedStates)[(*bKeys_pj)[i10]])[(*bKeys_lj)[i9]])[(*bKeys_p1)[i8]])[(*bKeys_p2)[i7]].rend(); itr6++) {
    ...
    void remove_dominated_states(const state& s, mt10* visitedStates) {
        ...
        for (int i10 = 0; i10 < keysNum_pj2; i10++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i10]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i10], keysNum_lj2, bKeys_lj2);
                
                for (int i9 = 0; i9 < keysNum_lj2; i9++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i10]]).find((*bKeys_lj2)[i9]) != ((*visitedStates)[(*bKeys_pj2)[i10]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i9], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i8 = 0; i8 < keysNum_p1_2; i8++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i10]][(*bKeys_lj2)[i9]]).find((*bKeys_p1_2)[i8]) != ((*visitedStates)[(*bKeys_pj2)[i10]][(*bKeys_lj2)[i9]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i9], (*bKeys_p1_2)[i8], keysNum_p2_2, bKeys_p2_2);
                                for (int i7 = 0; i7 < keysNum_p2_2; i7++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i10]][(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]].find((*bKeys_p2_2)[i7]) != ((*visitedStates)[(*bKeys_pj2)[i10]][(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]].end()) {
                                        
                                        for (mt6::iterator itr6 = ((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]])[(*bKeys_p2_2)[i7]].begin(); itr6 != ((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]])[(*bKeys_p2_2)[i7]].end();) {
                                            ...
                                            if (itr6->first > s.sumCs) break;
                                                ...
                                                if ((itr6->second).empty()) ((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]])[(*bKeys_p2_2)[i7]].erase(itr6++);
                                                else ++itr6;
                                            }
                                        }
                                        if (((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]])[(*bKeys_p2_2)[i7]].empty()) (((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]].erase((*bKeys_p2_2)[i7]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]])[(*bKeys_p1_2)[i8]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]]).erase((*bKeys_p1_2)[i8]);
                                
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i10]])[(*bKeys_lj2)[i9]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i10]]).erase((*bKeys_lj2)[i9]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i10]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i10]);
            }
    ...
    void add_state_to_map(const state& s, mt10* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.c[0]][s.c[1]] = true;
    }
    ...
    bool update_map(const state& s, mt10* visitedStates, const bool removeStates) {
...
} // end of namespace NS_2tasks_p2





bool test_2d_task_p2(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {

    NS_2tasks_p2::verbose = verbose_;
    
    bool schedulable = NS_2tasks_p2::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_2tasks_p2::savedStatesNum;
    visitedStatesNum_ = NS_2tasks_p2::visitedStatesNum;
