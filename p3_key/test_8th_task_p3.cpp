...
namespace NS_8tasks_p3 {
                    ...
                    if (((*visitedStates)[(*bKeys_pj)[i23]]).find((*bKeys_lj)[i22]) != ((*visitedStates)[(*bKeys_pj)[i23]]).end()) {
                        ...
                        for (int i21 = 0; i21 < keysNum_p1; i21++) { // p1 keys
                            ...
                            if ((((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]]).find((*bKeys_p1)[i21]) != (((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]]).end()) {
                                ...
                                get_keys_p2(s, ts, (*bKeys_lj)[i22], (*bKeys_p1)[i21], keysNum_p2, bKeys_p2);
                                for (int i20 = 0; i20 < keysNum_p2; i20++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]]).find((*bKeys_p2)[i20]) != (((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]].end()) {
                                        
                                        get_keys_p3(s, ts, (*bKeys_lj)[i22], (*bKeys_p1)[i21], (*bKeys_p2)[i20], keysNum_p3, bKeys_p3);
                                        for (int i19 = 0; i19 < keysNum_p3; i19++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]])[(*bKeys_p2)[i20]].find((*bKeys_p3)[i19]) != (((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]][(*bKeys_p2)[i20]].end()) {
                                                
                                                // sum of remaining execution times
                                                for (mt18::reverse_iterator itr18 = (((((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]]))[(*bKeys_p2)[i20]][(*bKeys_p3)[i19]].rbegin(); itr18 != (((((*visitedStates)[(*bKeys_pj)[i23]])[(*bKeys_lj)[i22]])[(*bKeys_p1)[i21]]))[(*bKeys_p2)[i20]][(*bKeys_p3)[i19]].rend(); itr18++) {
                                                    
                                                    if (itr18->first < s.sumCs) break;
                                                    else {
                                                        
                                                        for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                                            if (itr17->first > s.sumSlacks) break;
                                                            else if (find_dominating_state_p_iterations(s, itr17->second)) return true;
                                                        }
                                                    }
                                                }
                                            }
    ...
    void remove_dominated_states_c_iterations(const state& s, mt8& visitedStates8) {
        
        for (mt8::iterator itr8 = visitedStates8.begin(); itr8 != visitedStates8.end();) {
            if (itr8->first > s.c[0]) break;
            else {
                ...
                if ((itr8->second).empty()) (visitedStates8).erase(itr8++);
                else ++itr8;
            }
        } // itr8
    ...
    void remove_dominated_states_p_iterations(const state& s, mt16& visitedStates16) {
        ...
        for (mt16::reverse_iterator itr16 = visitedStates16.rbegin(); itr16 != visitedStates16.rend();) {
            if (itr16->first < s.t[0]) break;
                ...
                if ((itr16->second).empty()) visitedStates16.erase(--(itr16.base()));
                else ++itr16;
            }
        }
                    ...
                    if (((*visitedStates)[(*bKeys_pj2)[i23]]).find((*bKeys_lj2)[i22]) != ((*visitedStates)[(*bKeys_pj2)[i23]]).end()) {
                        ...
                        for (int i21 = 0; i21 < keysNum_p1_2; i21++) { // p1 key
                            ...
                            if (((*visitedStates)[(*bKeys_pj2)[i23]][(*bKeys_lj2)[i22]]).find((*bKeys_p1_2)[i21]) != ((*visitedStates)[(*bKeys_pj2)[i23]][(*bKeys_lj2)[i22]]).end()) {
                                ...
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i22], (*bKeys_p1_2)[i21], keysNum_p2_2, bKeys_p2_2);
                                for (int i20 = 0; i20 < keysNum_p2_2; i20++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i23]][(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]].find((*bKeys_p2_2)[i20]) != ((*visitedStates)[(*bKeys_pj2)[i23]][(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]].end()) {
                                        
                                        get_keys_p3_2(s, ts, (*bKeys_lj2)[i22], (*bKeys_p1_2)[i21], (*bKeys_p2_2)[i20], keysNum_p3_2, bKeys_p3_2);
                                        for (int i19 = 0; i19 < keysNum_p3_2; i19++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]])[(*bKeys_p2_2)[i20]].find((*bKeys_p3_2)[i19]) != (((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]][(*bKeys_p2_2)[i20]].end()) {
                                                
                                                
                                                for (mt18::iterator itr18 = (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]]))[(*bKeys_p2_2)[i20]][(*bKeys_p3_2)[i19]].begin(); itr18 != (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]]))[(*bKeys_p2_2)[i20]][(*bKeys_p3_2)[i19]].end();) {
                                                    ...
                                                    if (itr18->first > s.sumCs) break;
                                                        ...
                                                        for (mt17::reverse_iterator itr17 = (itr18->second).rbegin(); itr17 != (itr18->second).rend();) {
                                                            if (itr17->first < s.sumSlacks) break;
                                                            else remove_dominated_states_p_iterations(s, itr17->second);
                                                            
                                                            if ((itr17->second).empty()) (itr18->second).erase(--(itr17.base()));
                                                            else ++itr17;
                                                        }
                                                        
                                                        if ((itr18->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]]))[(*bKeys_p2_2)[i20]][(*bKeys_p3_2)[i19]].erase(itr18++);
                                                        else ++itr18;
                                                    }
                                                }
                                                
                                                if (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]])[(*bKeys_p2_2)[i20]][(*bKeys_p3_2)[i19]].empty()) (((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]][(*bKeys_p2_2)[i20]].erase((*bKeys_p3_2)[i19]);
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]])[(*bKeys_p2_2)[i20]].empty()) (((*visitedStates)[(*bKeys_pj2)[i23]])[(*bKeys_lj2)[i22]])[(*bKeys_p1_2)[i21]].erase((*bKeys_p2_2)[i20]);
                                    }
                                }
    ...
    void add_state_to_map(const state& s, mt23* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][bs_p3][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]] = true;
    }
    ...
    bool populate(const unsigned short m_, const TS& ts_, const bool removeStates) {
        ...
        if (verbose) {
            ...
            cout << "Visited states with tau_8 pending: " << visitedStatesNum_withTauKpending << "  ( " << (float)((int)(visitedStatesNum_withTauKpending*10000/visitedStatesNum))/100 << " %)" << endl << endl;
        }
        
        return schedulable;
    }
} // end of namespace NS_8tasks_p3





bool test_8th_task_p3(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_8tasks_p3::verbose = verbose_;
    
    bool schedulable = NS_8tasks_p3::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_8tasks_p3::savedStatesNum;
    visitedStatesNum_ = NS_8tasks_p3::visitedStatesNum;
