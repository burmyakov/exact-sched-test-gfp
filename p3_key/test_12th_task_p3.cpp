...
namespace NS_12tasks_p3 {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt24& visitedStates24) {
        ...
        for (mt24::iterator itr24 = visitedStates24.begin(); itr24 != visitedStates24.end(); itr24++) {
            if (itr24->first > s.t[0]) break;
            else {
                for (mt23::iterator itr23 = (itr24->second).begin(); itr23 != (itr24->second).end(); itr23++) {
                    if (itr23->first > s.t[1]) break;
                    else {
                        for (mt22::iterator itr22 = (itr23->second).begin(); itr22 != (itr23->second).end(); itr22++) {
                            if (itr22->first > s.t[2]) break;
                            else {
                                for (mt21::iterator itr21 = (itr22->second).begin(); itr21 != (itr22->second).end(); itr21++) {
                                    if (itr21->first > s.t[3]) break;
                                    else {
                                        for (mt20::iterator itr20 = (itr21->second).begin(); itr20 != (itr21->second).end(); itr20++) {
                                            if (itr20->first > s.t[4]) break;
                                            else {
                                                for (mt19::iterator itr19 = (itr20->second).begin(); itr19 != (itr20->second).end(); itr19++) {
                                                    if (itr19->first > s.t[5]) break;
                                                    else {
                                                        for (mt18::iterator itr18 = (itr19->second).begin(); itr18 != (itr19->second).end(); itr18++) {
                                                            if (itr18->first > s.t[6]) break;
                                                            else {
                                                                for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                                                    if (itr17->first > s.t[7]) break;
                                                                    else {
                                                                        for (mt16::iterator itr16 = (itr17->second).begin(); itr16 != (itr17->second).end(); itr16++) {
                                                                            if (itr16->first > s.t[8]) break;
                                                                            else {
                                                                                for (mt15::iterator itr15 = (itr16->second).begin(); itr15 != (itr16->second).end(); itr15++) {
                                                                                    if (itr15->first > s.t[9]) break;
                                                                                    else {
                                                                                        for (mt14::iterator itr14 = (itr15->second).begin(); itr14 != (itr15->second).end(); itr14++) {
                                                                                            if (itr14->first > s.t[10]) break;
                                                                                            else {
                                                                                                for (mt13::iterator itr13 = (itr14->second).begin(); itr13 != (itr14->second).end(); itr13++) {
                                                                                                    if (itr13->first > s.t[11]) break;
                    ...
                    if (((*visitedStates)[(*bKeys_pj)[i31]]).find((*bKeys_lj)[i30]) != ((*visitedStates)[(*bKeys_pj)[i31]]).end()) {
                        ...
                        for (int i29 = 0; i29 < keysNum_p1; i29++) { // p1 keys
                            ...
                            if ((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]]).find((*bKeys_p1)[i29]) != (((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]]).end()) {
                                ...
                                get_keys_p2(s, ts, (*bKeys_lj)[i30], (*bKeys_p1)[i29], keysNum_p2, bKeys_p2);
                                for (int i28 = 0; i28 < keysNum_p2; i28++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]]).find((*bKeys_p2)[i28]) != (((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]].end()) {
                                        
                                        get_keys_p3(s, ts, (*bKeys_lj)[i30], (*bKeys_p1)[i29], (*bKeys_p2)[i28], keysNum_p3, bKeys_p3);
                                        for (int i27 = 0; i27 < keysNum_p3; i27++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]])[(*bKeys_p2)[i28]].find((*bKeys_p3)[i27]) != (((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]][(*bKeys_p2)[i28]].end()) {
                                                
                                                // sum of remaining execution times
                                                for (mt26::reverse_iterator itr26 = (((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]]))[(*bKeys_p2)[i28]][(*bKeys_p3)[i27]].rbegin(); itr26 != (((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]]))[(*bKeys_p2)[i28]][(*bKeys_p3)[i27]].rend(); itr26++) {
                    ...
                    if (((*visitedStates)[(*bKeys_pj2)[i31]]).find((*bKeys_lj2)[i30]) != ((*visitedStates)[(*bKeys_pj2)[i31]]).end()) {
                        ...
                        for (int i29 = 0; i29 < keysNum_p1_2; i29++) { // p1 key
                            ...
                            if (((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]]).find((*bKeys_p1_2)[i29]) != ((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]]).end()) {
                                ...
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i30], (*bKeys_p1_2)[i29], keysNum_p2_2, bKeys_p2_2);
                                for (int i28 = 0; i28 < keysNum_p2_2; i28++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]].find((*bKeys_p2_2)[i28]) != ((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]].end()) {
                                        
                                        get_keys_p3_2(s, ts, (*bKeys_lj2)[i30], (*bKeys_p1_2)[i29], (*bKeys_p2_2)[i28], keysNum_p3_2, bKeys_p3_2);
                                        for (int i27 = 0; i27 < keysNum_p3_2; i27++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])[(*bKeys_p2_2)[i28]].find((*bKeys_p3_2)[i27]) != (((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]][(*bKeys_p2_2)[i28]].end()) {
                                                
                                                
                                                for (mt26::iterator itr26 = (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]]))[(*bKeys_p2_2)[i28]][(*bKeys_p3_2)[i27]].begin(); itr26 != (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]]))[(*bKeys_p2_2)[i28]][(*bKeys_p3_2)[i27]].end();) {
                                                    ...
                                                    if (itr26->first > s.sumCs) break;
                                                        ...
                                                        if ((itr26->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]]))[(*bKeys_p2_2)[i28]][(*bKeys_p3_2)[i27]].erase(itr26++);
                                                        else ++itr26;
                                                    }
                                                }
                                                
                                                if (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])[(*bKeys_p2_2)[i28]][(*bKeys_p3_2)[i27]].empty()) (((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]][(*bKeys_p2_2)[i28]].erase((*bKeys_p3_2)[i27]);
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])[(*bKeys_p2_2)[i28]].empty()) (((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]].erase((*bKeys_p2_2)[i28]);
                                    }
                                }
    ...
    void add_state_to_map(const state& s, mt31* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][bs_p3][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.t[11]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]] = true;
    }
...
} // end of namespace NS_12tasks_p3





bool test_12th_task_p3(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_12tasks_p3::verbose = verbose_;
    
    bool schedulable = NS_12tasks_p3::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_12tasks_p3::savedStatesNum;
    visitedStatesNum_ = NS_12tasks_p3::visitedStatesNum;
