...
namespace NS_11tasks_p3 {
    ...
    bool find_dominating_state(const state& s, mt29* visitedStates) {
        ...
        for (int i29 = 0; i29 < keysNum_pj; i29++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i29]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i29], keysNum_lj, bKeys_lj);
                for (int i28 = 0; i28 < keysNum_lj; i28++) { // locked jobs binary key
                    ...
                    if (((*visitedStates)[(*bKeys_pj)[i29]]).find((*bKeys_lj)[i28]) != ((*visitedStates)[(*bKeys_pj)[i29]]).end()) {
                        ...
                        for (int i27 = 0; i27 < keysNum_p1; i27++) { // p1 keys
                            
                            if ((((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]]).find((*bKeys_p1)[i27]) != (((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i28], (*bKeys_p1)[i27], keysNum_p2, bKeys_p2);
                                for (int i26 = 0; i26 < keysNum_p2; i26++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]]).find((*bKeys_p2)[i26]) != (((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]].end()) {
                                        
                                        get_keys_p3(s, ts, (*bKeys_lj)[i28], (*bKeys_p1)[i27], (*bKeys_p2)[i26], keysNum_p3, bKeys_p3);
                                        for (int i25 = 0; i25 < keysNum_p3; i25++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]])[(*bKeys_p2)[i26]].find((*bKeys_p3)[i25]) != (((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]][(*bKeys_p2)[i26]].end()) {
                                                
                                                // sum of remaining execution times
                                                for (mt24::reverse_iterator itr24 = (((((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]]))[(*bKeys_p2)[i26]][(*bKeys_p3)[i25]].rbegin(); itr24 != (((((*visitedStates)[(*bKeys_pj)[i29]])[(*bKeys_lj)[i28]])[(*bKeys_p1)[i27]]))[(*bKeys_p2)[i26]][(*bKeys_p3)[i25]].rend(); itr24++) {
    ...
    void remove_dominated_states(const state& s, mt29* visitedStates) {
        ...
        for (int i29 = 0; i29 < keysNum_pj2; i29++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i29]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i29], keysNum_lj2, bKeys_lj2);
                
                for (int i28 = 0; i28 < keysNum_lj2; i28++) { // locked jobs binary key
                    ...
                    if (((*visitedStates)[(*bKeys_pj2)[i29]]).find((*bKeys_lj2)[i28]) != ((*visitedStates)[(*bKeys_pj2)[i29]]).end()) {
                        ...
                        for (int i27 = 0; i27 < keysNum_p1_2; i27++) { // p1 key
                            
                            if (((*visitedStates)[(*bKeys_pj2)[i29]][(*bKeys_lj2)[i28]]).find((*bKeys_p1_2)[i27]) != ((*visitedStates)[(*bKeys_pj2)[i29]][(*bKeys_lj2)[i28]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i28], (*bKeys_p1_2)[i27], keysNum_p2_2, bKeys_p2_2);
                                for (int i26 = 0; i26 < keysNum_p2_2; i26++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i29]][(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]].find((*bKeys_p2_2)[i26]) != ((*visitedStates)[(*bKeys_pj2)[i29]][(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]].end()) {
                                        
                                        get_keys_p3_2(s, ts, (*bKeys_lj2)[i28], (*bKeys_p1_2)[i27], (*bKeys_p2_2)[i26], keysNum_p3_2, bKeys_p3_2);
                                        for (int i25 = 0; i25 < keysNum_p3_2; i25++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]])[(*bKeys_p2_2)[i26]].find((*bKeys_p3_2)[i25]) != (((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]][(*bKeys_p2_2)[i26]].end()) {
                                                
                                                
                                                for (mt24::iterator itr24 = (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]]))[(*bKeys_p2_2)[i26]][(*bKeys_p3_2)[i25]].begin(); itr24 != (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]]))[(*bKeys_p2_2)[i26]][(*bKeys_p3_2)[i25]].end();) {
                                                    ...
                                                    if (itr24->first > s.sumCs) break;
                                                        ...
                                                        if ((itr24->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]]))[(*bKeys_p2_2)[i26]][(*bKeys_p3_2)[i25]].erase(itr24++);
                                                        else ++itr24;
                                                    }
                                                }
                                                
                                                if (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]])[(*bKeys_p2_2)[i26]][(*bKeys_p3_2)[i25]].empty()) (((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]][(*bKeys_p2_2)[i26]].erase((*bKeys_p3_2)[i25]);
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]])[(*bKeys_p2_2)[i26]].empty()) (((*visitedStates)[(*bKeys_pj2)[i29]])[(*bKeys_lj2)[i28]])[(*bKeys_p1_2)[i27]].erase((*bKeys_p2_2)[i26]);
                                    }
                                }
    ...
    void add_state_to_map(const state& s, mt29* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][bs_p3][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]] = true;
    }
...
} // end of namespace NS_11tasks_p3





bool test_11th_task_p3(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_11tasks_p3::verbose = verbose_;
    
    bool schedulable = NS_11tasks_p3::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_11tasks_p3::savedStatesNum;
    visitedStatesNum_ = NS_11tasks_p3::visitedStatesNum;
