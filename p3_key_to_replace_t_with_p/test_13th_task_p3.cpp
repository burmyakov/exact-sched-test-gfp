...
namespace NS_13tasks_p3 {
    ...
    void get_states_num(mt33* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt33::iterator itr33 = (*generated).begin(); itr33 != (*generated).end(); itr33++) {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt26& visitedStates26) {
        
        for (mt26::iterator itr26 = visitedStates26.begin(); itr26 != visitedStates26.end(); itr26++) {
            if (itr26->first > s.t[0]) break;
            else {
                for (mt25::iterator itr25 = (itr26->second).begin(); itr25 != (itr26->second).end(); itr25++) {
                    if (itr25->first > s.t[0]) break;
                    else {
                        for (mt24::iterator itr24 = (itr25->second).begin(); itr24 != (itr25->second).end(); itr24++) {
                            if (itr24->first > s.t[1]) break;
                            else {
                                for (mt23::iterator itr23 = (itr24->second).begin(); itr23 != (itr24->second).end(); itr23++) {
                                    if (itr23->first > s.t[2]) break;
                                    else {
                                        for (mt22::iterator itr22 = (itr23->second).begin(); itr22 != (itr23->second).end(); itr22++) {
                                            if (itr22->first > s.t[3]) break;
                                            else {
                                                for (mt21::iterator itr21 = (itr22->second).begin(); itr21 != (itr22->second).end(); itr21++) {
                                                    if (itr21->first > s.t[4]) break;
                                                    else {
                                                        for (mt20::iterator itr20 = (itr21->second).begin(); itr20 != (itr21->second).end(); itr20++) {
                                                            if (itr20->first > s.t[5]) break;
                                                            else {
                                                                for (mt19::iterator itr19 = (itr20->second).begin(); itr19 != (itr20->second).end(); itr19++) {
                                                                    if (itr19->first > s.t[6]) break;
                                                                    else {
                                                                        for (mt18::iterator itr18 = (itr19->second).begin(); itr18 != (itr19->second).end(); itr18++) {
                                                                            if (itr18->first > s.t[7]) break;
                                                                            else {
                                                                                for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                                                                    if (itr17->first > s.t[8]) break;
                                                                                    else {
                                                                                        for (mt16::iterator itr16 = (itr17->second).begin(); itr16 != (itr17->second).end(); itr16++) {
                                                                                            if (itr16->first > s.t[9]) break;
                                                                                            else {
                                                                                                for (mt15::iterator itr15 = (itr16->second).begin(); itr15 != (itr16->second).end(); itr15++) {
                                                                                                    if (itr15->first > s.t[10]) break;
                                                                                                    else {
                                                                                                        for (mt14::iterator itr14 = (itr15->second).begin(); itr14 != (itr15->second).end(); itr14++) {
                                                                                                            if (itr14->first > s.t[11]) break;
                                                                                                            else if (find_dominating_state_c_iterations(s, itr14->second)) return true;
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
    ...
    bool find_dominating_state(const state& s, mt33* visitedStates) {
        ...
        for (int i33 = 0; i33 < keysNum_pj; i33++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i33]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i33], keysNum_lj, bKeys_lj);
                for (int i32 = 0; i32 < keysNum_lj; i32++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj)[i33]]).find((*bKeys_lj)[i32]) != ((*visitedStates)[(*bKeys_pj)[i33]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i32], keysNum_p1, bKeys_p1);
                        for (int i31 = 0; i31 < keysNum_p1; i31++) { // p1 keys
                            
                            if ((((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]]).find((*bKeys_p1)[i31]) != (((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i32], (*bKeys_p1)[i31], keysNum_p2, bKeys_p2);
                                for (int i30 = 0; i30 < keysNum_p2; i30++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]]).find((*bKeys_p2)[i30]) != (((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]].end()) {
                                        
                                        get_keys_p3(s, ts, (*bKeys_lj)[i32], (*bKeys_p1)[i31], (*bKeys_p2)[i30], keysNum_p3, bKeys_p3);
                                        for (int i29 = 0; i29 < keysNum_p3; i29++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]])[(*bKeys_p2)[i30]].find((*bKeys_p3)[i29]) != (((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]][(*bKeys_p2)[i30]].end()) {
                                                
                                                // sum of remaining execution times
                                                for (mt28::reverse_iterator itr28 = (((((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]]))[(*bKeys_p2)[i30]][(*bKeys_p3)[i29]].rbegin(); itr28 != (((((*visitedStates)[(*bKeys_pj)[i33]])[(*bKeys_lj)[i32]])[(*bKeys_p1)[i31]]))[(*bKeys_p2)[i30]][(*bKeys_p3)[i29]].rend(); itr28++) {
                                                    
                                                    if (itr28->first < s.sumCs) break;
                                                    else {
                                                        
                                                        for (mt27::iterator itr27 = (itr28->second).begin(); itr27 != (itr28->second).end(); itr27++) {
                                                            if (itr27->first > s.sumSlacks) break;
                                                            else if (find_dominating_state_p_iterations(s, itr27->second)) return true;
                                                        }
                                                    }
                                                }
                                            }
    ...
    void remove_dominated_states_c_iterations(const state& s, mt13& visitedStates13) {
        
        for (mt13::iterator itr13 = visitedStates13.begin(); itr13 != visitedStates13.end();) {
            if (itr13->first > s.c[0]) break;
            else {
                ...
                if ((itr13->second).empty()) (visitedStates13).erase(itr13++);
                else ++itr13;
            }
        } // itr13
    ...
    void remove_dominated_states_p_iterations(const state& s, mt26& visitedStates26) {
        ...
        for (mt26::reverse_iterator itr26 = visitedStates26.rbegin(); itr26 != visitedStates26.rend();) {
            if (itr26->first < s.t[0]) break;
                ...
                if ((itr26->second).empty()) visitedStates26.erase(--(itr26.base()));
                else ++itr26;
            }
        }
    ...
    void remove_dominated_states(const state& s, mt33* visitedStates) {
        ...
        for (int i33 = 0; i33 < keysNum_pj2; i33++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i33]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i33], keysNum_lj2, bKeys_lj2);
                
                for (int i32 = 0; i32 < keysNum_lj2; i32++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj2)[i33]]).find((*bKeys_lj2)[i32]) != ((*visitedStates)[(*bKeys_pj2)[i33]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i32], keysNum_p1_2, bKeys_p1_2);
                        for (int i31 = 0; i31 < keysNum_p1_2; i31++) { // p1 key
                            
                            if (((*visitedStates)[(*bKeys_pj2)[i33]][(*bKeys_lj2)[i32]]).find((*bKeys_p1_2)[i31]) != ((*visitedStates)[(*bKeys_pj2)[i33]][(*bKeys_lj2)[i32]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i32], (*bKeys_p1_2)[i31], keysNum_p2_2, bKeys_p2_2);
                                for (int i30 = 0; i30 < keysNum_p2_2; i30++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i33]][(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]].find((*bKeys_p2_2)[i30]) != ((*visitedStates)[(*bKeys_pj2)[i33]][(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]].end()) {
                                        
                                        get_keys_p3_2(s, ts, (*bKeys_lj2)[i32], (*bKeys_p1_2)[i31], (*bKeys_p2_2)[i30], keysNum_p3_2, bKeys_p3_2);
                                        for (int i29 = 0; i29 < keysNum_p3_2; i29++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]])[(*bKeys_p2_2)[i30]].find((*bKeys_p3_2)[i29]) != (((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]][(*bKeys_p2_2)[i30]].end()) {
                                                
                                                
                                                for (mt28::iterator itr28 = (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]]))[(*bKeys_p2_2)[i30]][(*bKeys_p3_2)[i29]].begin(); itr28 != (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]]))[(*bKeys_p2_2)[i30]][(*bKeys_p3_2)[i29]].end();) {
                                                    ...
                                                    if (itr28->first > s.sumCs) break;
                                                        ...
                                                        for (mt27::reverse_iterator itr27 = (itr28->second).rbegin(); itr27 != (itr28->second).rend();) {
                                                            if (itr27->first < s.sumSlacks) break;
                                                            else remove_dominated_states_p_iterations(s, itr27->second);
                                                            
                                                            if ((itr27->second).empty()) (itr28->second).erase(--(itr27.base()));
                                                            else ++itr27;
                                                        }
                                                        
                                                        if ((itr28->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]]))[(*bKeys_p2_2)[i30]][(*bKeys_p3_2)[i29]].erase(itr28++);
                                                        else ++itr28;
                                                    }
                                                }
                                                
                                                if (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]])[(*bKeys_p2_2)[i30]][(*bKeys_p3_2)[i29]].empty()) (((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]][(*bKeys_p2_2)[i30]].erase((*bKeys_p3_2)[i29]);
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]])[(*bKeys_p2_2)[i30]].empty()) (((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]].erase((*bKeys_p2_2)[i30]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]])[(*bKeys_p1_2)[i31]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]]).erase((*bKeys_p1_2)[i31]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i33]])[(*bKeys_lj2)[i32]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i33]]).erase((*bKeys_lj2)[i32]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i33]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i33]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt33* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][bs_p3][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.t[11]][s.t[12]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]][s.c[12]] = true;
    }
    ...
    bool update_map(const state& s, mt33* visitedStates, const bool removeStates) {
    ...
    bool populate(const unsigned short m_, const TS& ts_, const bool removeStates) {
        ...
        if (verbose) {
            ...
            cout << "Visited states with tau_13 pending: " << visitedStatesNum_withTauKpending << "  ( " << (float)((int)(visitedStatesNum_withTauKpending*10000/visitedStatesNum))/100 << " %)" << endl << endl;
        }
        
        return schedulable;
    }
} // end of namespace NS_13tasks_p3





bool test_13th_task_p3(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_13tasks_p3::verbose = verbose_;
    
    bool schedulable = NS_13tasks_p3::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_13tasks_p3::savedStatesNum;
    visitedStatesNum_ = NS_13tasks_p3::visitedStatesNum;
