...
namespace NS_6tasks_p3 {
    ...
    void get_states_num(mt19* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt19::iterator itr19 = (*generated).begin(); itr19 != (*generated).end(); itr19++) {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt12& visitedStates12) {
        ...
        for (mt12::iterator itr12 = visitedStates12.begin(); itr12 != visitedStates12.end(); itr12++) {
            ...
            if (itr12->first > s.t[0]) break;
            else {
                
                for (mt11::iterator itr11 = (itr12->second).begin(); itr11 != (itr12->second).end(); itr11++) {
                    if (itr11->first > s.t[1]) break;
                    else {
                        for (mt10::iterator itr10 = (itr11->second).begin(); itr10 != (itr11->second).end(); itr10++) {
                            if (itr10->first > s.t[2]) break;
                            else {
                                
                                for (mt9::iterator itr9 = (itr10->second).begin(); itr9 != (itr10->second).end(); itr9++) {
                                    if (itr9->first > s.t[3]) break;
                                    else {
                                        for (mt8::iterator itr8 = (itr9->second).begin(); itr8 != (itr9->second).end(); itr8++) {
                                            if (itr8->first > s.t[4]) break;
                                            else {
                                                for (mt7::iterator itr7 = (itr8->second).begin(); itr7 != (itr8->second).end(); itr7++) {
                                                    if (itr7->first > s.t[5]) break;
    ...
    bool find_dominating_state(const state& s, mt19* visitedStates) {
        ...
        for (int i19 = 0; i19 < keysNum_pj; i19++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i19]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i19], keysNum_lj, bKeys_lj);
                for (int i18 = 0; i18 < keysNum_lj; i18++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj)[i19]]).find((*bKeys_lj)[i18]) != ((*visitedStates)[(*bKeys_pj)[i19]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i18], keysNum_p1, bKeys_p1);
                        for (int i17 = 0; i17 < keysNum_p1; i17++) { // p1 keys
                            
                            if ((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]]).find((*bKeys_p1)[i17]) != (((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]]).end()) {
                                
                                get_keys_p2(s, ts, (*bKeys_lj)[i18], (*bKeys_p1)[i17], keysNum_p2, bKeys_p2);
                                for (int i16 = 0; i16 < keysNum_p2; i16++) {
                                    
                                    if (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]]).find((*bKeys_p2)[i16]) != (((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]].end()) {
                                        
                                        get_keys_p3(s, ts, (*bKeys_lj)[i18], (*bKeys_p1)[i17], (*bKeys_p2)[i16], keysNum_p3, bKeys_p3);
                                        for (int i15 = 0; i15 < keysNum_p3; i15++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]])[(*bKeys_p2)[i16]].find((*bKeys_p3)[i15]) != (((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]][(*bKeys_p2)[i16]].end()) {
                                                
                                                // sum of remaining execution times
                                                for (mt14::reverse_iterator itr14 = (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]]))[(*bKeys_p2)[i16]][(*bKeys_p3)[i15]].rbegin(); itr14 != (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]]))[(*bKeys_p2)[i16]][(*bKeys_p3)[i15]].rend(); itr14++) {
    ...
    void remove_dominated_states(const state& s, mt19* visitedStates) {
        ...
        for (int i19 = 0; i19 < keysNum_pj2; i19++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i19]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i19], keysNum_lj2, bKeys_lj2);
                
                for (int i18 = 0; i18 < keysNum_lj2; i18++) { // locked jobs binary key
                    
                    if (((*visitedStates)[(*bKeys_pj2)[i19]]).find((*bKeys_lj2)[i18]) != ((*visitedStates)[(*bKeys_pj2)[i19]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i18], keysNum_p1_2, bKeys_p1_2);
                        for (int i17 = 0; i17 < keysNum_p1_2; i17++) { // p1 key
                            
                            if (((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]]).find((*bKeys_p1_2)[i17]) != ((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]]).end()) {
                                
                                get_keys_p2_2(s, ts, (*bKeys_lj2)[i18], (*bKeys_p1_2)[i17], keysNum_p2_2, bKeys_p2_2);
                                for (int i16 = 0; i16 < keysNum_p2_2; i16++) {
                                    
                                    if (((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]].find((*bKeys_p2_2)[i16]) != ((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]].end()) {
                                        
                                        get_keys_p3_2(s, ts, (*bKeys_lj2)[i18], (*bKeys_p1_2)[i17], (*bKeys_p2_2)[i16], keysNum_p3_2, bKeys_p3_2);
                                        for (int i15 = 0; i15 < keysNum_p3_2; i15++) {
                                            
                                            if (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])[(*bKeys_p2_2)[i16]].find((*bKeys_p3_2)[i15]) != (((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]][(*bKeys_p2_2)[i16]].end()) {
                                                
                                                
                                                for (mt14::iterator itr14 = (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]]))[(*bKeys_p2_2)[i16]][(*bKeys_p3_2)[i15]].begin(); itr14 != (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]]))[(*bKeys_p2_2)[i16]][(*bKeys_p3_2)[i15]].end();) {
                                                    ...
                                                    if (itr14->first > s.sumCs) break;
                                                        ...
                                                        if ((itr14->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]]))[(*bKeys_p2_2)[i16]][(*bKeys_p3_2)[i15]].erase(itr14++);
                                                        else ++itr14;
                                                    }
                                                }
                                                
                                                if (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])[(*bKeys_p2_2)[i16]][(*bKeys_p3_2)[i15]].empty()) (((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]][(*bKeys_p2_2)[i16]].erase((*bKeys_p3_2)[i15]);
                                            }
                                        }
                                        
                                        if (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])[(*bKeys_p2_2)[i16]].empty()) (((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]].erase((*bKeys_p2_2)[i16]);
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]]).erase((*bKeys_p1_2)[i17]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i19]]).erase((*bKeys_lj2)[i18]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i19]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i19]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt19* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][bs_p2][bs_p3][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]] = true;
    }
    ...
    bool update_map(const state& s, mt19* visitedStates, const bool removeStates) {
...
} // end of namespace NS_6tasks_p3





bool test_6th_task_p3(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_6tasks_p3::verbose = verbose_;
    
    bool schedulable = NS_6tasks_p3::populate(m_, ts_, removeStates_);
    savedStatesNum_ = NS_6tasks_p3::savedStatesNum;
    visitedStatesNum_ = NS_6tasks_p3::visitedStatesNum;
