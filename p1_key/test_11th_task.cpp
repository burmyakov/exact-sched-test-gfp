...
namespace NS_11tasks {
    ...
    bool find_dominating_state(const state& s, mt27* visitedStates) {
        ...
        for (unsigned int i27 = 0; i27 < keysNum_pj; i27++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i27]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i27], keysNum_lj, bKeys_lj);
                
                for (unsigned int i26 = 0; i26 < keysNum_lj; i26++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i27]]).find((*bKeys_lj)[i26]) != ((*visitedStates)[(*bKeys_pj)[i27]]).end()) {
                        ...
                        for (unsigned int i25 = 0; i25 < keysNum_p1; i25++) { // p1 keys
    ...
    void remove_dominated_states(const state& s, mt27* visitedStates) {
        ...
        for (unsigned int i27 = 0; i27 < keysNum_pj2; i27++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i27]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i27], keysNum_lj2, bKeys_lj2);
                
                for (unsigned int i26 = 0; i26 < keysNum_lj2; i26++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i27]]).find((*bKeys_lj2)[i26]) != ((*visitedStates)[(*bKeys_pj2)[i27]]).end()) {
                        ...
                        for (unsigned int i25 = 0; i25 < keysNum_p1_2; i25++) { // p1 key
...
bool test_11th_task(const bool verbose_, const uint8_t m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
