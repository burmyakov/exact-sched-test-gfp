...
namespace NS_13tasks {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt26& visitedStates26) {
        ...
        for (mt26::iterator itr26 = visitedStates26.begin(); itr26 != visitedStates26.end(); itr26++) {
            if (itr26->first > s.p[0]) break;
                ...
                for (mt25::iterator itr25 = (itr26->second).begin(); itr25 != (itr26->second).end(); itr25++) {
                    if (itr25->first > s.p[0]) break;
                    else {
                        for (mt24::iterator itr24 = (itr25->second).begin(); itr24 != (itr25->second).end(); itr24++) {
                            if (itr24->first > s.p[1]) break;
                            else {
                                for (mt23::iterator itr23 = (itr24->second).begin(); itr23 != (itr24->second).end(); itr23++) {
                                    if (itr23->first > s.p[2]) break;
                                    else {
                                        for (mt22::iterator itr22 = (itr23->second).begin(); itr22 != (itr23->second).end(); itr22++) {
                                            if (itr22->first > s.p[3]) break;
                                            else {
                                                for (mt21::iterator itr21 = (itr22->second).begin(); itr21 != (itr22->second).end(); itr21++) {
                                                    if (itr21->first > s.p[4]) break;
                                                    else {
                                                        for (mt20::iterator itr20 = (itr21->second).begin(); itr20 != (itr21->second).end(); itr20++) {
                                                            if (itr20->first > s.p[5]) break;
                                                            else {
                                                                for (mt19::iterator itr19 = (itr20->second).begin(); itr19 != (itr20->second).end(); itr19++) {
                                                                    if (itr19->first > s.p[6]) break;
                                                                    else {
                                                                        for (mt18::iterator itr18 = (itr19->second).begin(); itr18 != (itr19->second).end(); itr18++) {
                                                                            if (itr18->first > s.p[7]) break;
                                                                            else {
                                                                                for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                                                                    if (itr17->first > s.p[8]) break;
                                                                                    else {
                                                                                        for (mt16::iterator itr16 = (itr17->second).begin(); itr16 != (itr17->second).end(); itr16++) {
                                                                                            if (itr16->first > s.p[9]) break;
                                                                                            else {
                                                                                                for (mt15::iterator itr15 = (itr16->second).begin(); itr15 != (itr16->second).end(); itr15++) {
                                                                                                    if (itr15->first > s.p[10]) break;
                                                                                                    else {
                                                                                                        for (mt14::iterator itr14 = (itr15->second).begin(); itr14 != (itr15->second).end(); itr14++) {
                                                                                                            if (itr14->first > s.p[11]) break;
    ...
    bool find_dominating_state(const state& s, mt31* visitedStates) {
        ...
        for (unsigned int i31 = 0; i31 < keysNum_pj; i31++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i31]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i31], keysNum_lj, bKeys_lj);
                
                for (unsigned int i30 = 0; i30 < keysNum_lj; i30++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i31]]).find((*bKeys_lj)[i30]) != ((*visitedStates)[(*bKeys_pj)[i31]]).end()) {
                        ...
                        for (unsigned int i29 = 0; i29 < keysNum_p1; i29++) { // p1 keys
    ...
    void remove_dominated_states(const state& s, mt31* visitedStates) {
        ...
        for (unsigned int i31 = 0; i31 < keysNum_pj2; i31++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i31]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i31], keysNum_lj2, bKeys_lj2);
                
                for (unsigned int i30 = 0; i30 < keysNum_lj2; i30++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i31]]).find((*bKeys_lj2)[i30]) != ((*visitedStates)[(*bKeys_pj2)[i31]]).end()) {
                        ...
                        for (unsigned int i29 = 0; i29 < keysNum_p1_2; i29++) { // p1 key
    ...
    void add_state_to_map(const state& s, mt31* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][s.sumCs][s.sumSlacks][s.p[0]][s.p[1]][s.p[2]][s.p[3]][s.p[4]][s.p[5]][s.p[6]][s.p[7]][s.p[8]][s.p[9]][s.p[10]][s.p[11]][s.p[12]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]][s.c[12]] = true;
    }
...
bool test_13th_task(const bool verbose_, const uint8_t m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
