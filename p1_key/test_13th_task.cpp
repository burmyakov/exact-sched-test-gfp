...
namespace NS_13tasks {
    ...
    void get_states_num(mt31* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt31::iterator itr31 = (*generated).begin(); itr31 != (*generated).end(); itr31++) {
    ...
    bool find_dominating_state(const state& s, mt31* visitedStates) {
        ...
        for (int i31 = 0; i31 < keysNum_pj; i31++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i31]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i31], keysNum_lj, bKeys_lj);
                
                for (int i30 = 0; i30 < keysNum_lj; i30++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i31]]).find((*bKeys_lj)[i30]) != ((*visitedStates)[(*bKeys_pj)[i31]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i30], keysNum_p1, bKeys_p1);
                        
                        for (int i29 = 0; i29 < keysNum_p1; i29++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]]).find((*bKeys_p1)[i29]) != (((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]]).end()) {
                                
                                // sum of remaining execution times
                                for (mt28::reverse_iterator itr28 = ((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]]).rbegin(); itr28 != ((((*visitedStates)[(*bKeys_pj)[i31]])[(*bKeys_lj)[i30]])[(*bKeys_p1)[i29]]).rend(); itr28++) {
    ...
    void remove_dominated_states(const state& s, mt31* visitedStates) {
        ...
        for (int i31 = 0; i31 < keysNum_pj2; i31++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i31]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i31], keysNum_lj2, bKeys_lj2);
                
                for (int i30 = 0; i30 < keysNum_lj2; i30++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i31]]).find((*bKeys_lj2)[i30]) != ((*visitedStates)[(*bKeys_pj2)[i31]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i30], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i29 = 0; i29 < keysNum_p1_2; i29++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]]).find((*bKeys_p1_2)[i29]) != ((*visitedStates)[(*bKeys_pj2)[i31]][(*bKeys_lj2)[i30]]).end()) {
                                
                                for (mt28::iterator itr28 = (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])).begin(); itr28 != (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])).end();) {
                                    ...
                                    if (itr28->first > s.sumCs) break;
                                        ...
                                        if ((itr28->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]])).erase(itr28++);
                                        else ++itr28;
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]])[(*bKeys_p1_2)[i29]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]]).erase((*bKeys_p1_2)[i29]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i31]])[(*bKeys_lj2)[i30]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i31]]).erase((*bKeys_lj2)[i30]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i31]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i31]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt31* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.t[10]][s.t[11]][s.t[12]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]][s.c[10]][s.c[11]][s.c[12]] = true;
    }
    ...
    bool update_map(const state& s, mt31* visitedStates, const bool removeStates) {
...
bool test_13th_task(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_13tasks::verbose = verbose_;
    
    bool schedulable = NS_13tasks::populate(m_, ts_, removeStates_);
