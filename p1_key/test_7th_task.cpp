...
namespace NS_7tasks {
            ...
            if (itr14->first > s.p[0]) break;
                ...
                for (mt13::iterator itr13 = (itr14->second).begin(); itr13 != (itr14->second).end(); itr13++) {
                    if (itr13->first > s.p[1]) break;
                        ...
                        for (mt12::iterator itr12 = (itr13->second).begin(); itr12 != (itr13->second).end(); itr12++) {
                            if (itr12->first > s.p[2]) break;
                            else {
                                for (mt11::iterator itr11 = (itr12->second).begin(); itr11 != (itr12->second).end(); itr11++) {
                                    if (itr11->first > s.p[3]) break;
                                    else {
                                        for (mt10::iterator itr10 = (itr11->second).begin(); itr10 != (itr11->second).end(); itr10++) {
                                            if (itr10->first > s.p[4]) break;
                                            else {
                                                for (mt9::iterator itr9 = (itr10->second).begin(); itr9 != (itr10->second).end(); itr9++) {
                                                    if (itr9->first > s.p[5]) break;
                                                    else {
                                                        for (mt8::iterator itr8 = (itr9->second).begin(); itr8 != (itr9->second).end(); itr8++) {
                                                            if (itr8->first > s.p[6]) break;
                    ...
                    if (((*visitedStates)[(*bKeys_pj)[i19]]).find((*bKeys_lj)[i18]) != ((*visitedStates)[(*bKeys_pj)[i19]]).end()) {
                        ...
                        for (int i17 = 0; i17 < keysNum_p1; i17++) { // p1 keys
                            ...
                            if ((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]]).find((*bKeys_p1)[i17]) != (((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]]).end()) {
                                ...
                                for (mt16::reverse_iterator itr16 = (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]])).rbegin(); itr16 != (((((*visitedStates)[(*bKeys_pj)[i19]])[(*bKeys_lj)[i18]])[(*bKeys_p1)[i17]])).rend(); itr16++) {
                    ...
                    if (((*visitedStates)[(*bKeys_pj2)[i19]]).find((*bKeys_lj2)[i18]) != ((*visitedStates)[(*bKeys_pj2)[i19]]).end()) {
                        ...
                        for (int i17 = 0; i17 < keysNum_p1_2; i17++) { // p1 key
                            ...
                            if (((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]]).find((*bKeys_p1_2)[i17]) != ((*visitedStates)[(*bKeys_pj2)[i19]][(*bKeys_lj2)[i18]]).end()) {
                                ...
                                for (mt16::iterator itr16 = (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])).begin(); itr16 != (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])).end();) {
                                    ...
                                    if (itr16->first > s.sumCs) break;
                                        ...
                                        if ((itr16->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i19]])[(*bKeys_lj2)[i18]])[(*bKeys_p1_2)[i17]])).erase(itr16++);
                                        else ++itr16;
                                    }
                                }
    ...
    void add_state_to_map(const state& s, mt19* visitedStates) {
        ...
        my_bitset bs_p1;
        for (unsigned short i = 0; i < ts.n; i++) if (s.p[i] > ((float)(ts.P[i]))/2) bs_p1.set(i, 1); else bs_p1.set(i, 0);
        
        my_bitset bs_lj;
        for (unsigned short i = 0; i < ts.n; i++) if (s.p[i] > 0) bs_lj.set(i, 1); else bs_lj.set(i, 0);

        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][s.sumCs][s.sumSlacks][s.p[0]][s.p[1]][s.p[2]][s.p[3]][s.p[4]][s.p[5]][s.p[6]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]] = true;
    }
...
bool test_7th_task(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
