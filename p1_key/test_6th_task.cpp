...
namespace NS_6tasks {
    ...
    bool find_dominating_state(const state& s, mt17* visitedStates) {
        ...
        for (unsigned int i17 = 0; i17 < keysNum_pj; i17++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i17]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i17], keysNum_lj, bKeys_lj);
                
                for (unsigned int i16 = 0; i16 < keysNum_lj; i16++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i17]]).find((*bKeys_lj)[i16]) != ((*visitedStates)[(*bKeys_pj)[i17]]).end()) {
                        ...
                        for (unsigned int i15 = 0; i15 < keysNum_p1; i15++) { // p1 keys
    ...
    void remove_dominated_states(const state& s, mt17* visitedStates) {
        ...
        for (unsigned int i17 = 0; i17 < keysNum_pj2; i17++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i17]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i17], keysNum_lj2, bKeys_lj2);
                
                for (unsigned int i16 = 0; i16 < keysNum_lj2; i16++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i17]]).find((*bKeys_lj2)[i16]) != ((*visitedStates)[(*bKeys_pj2)[i17]]).end()) {
                        ...
                        for (unsigned int i15 = 0; i15 < keysNum_p1_2; i15++) { // p1 key
...
bool test_6th_task(const bool verbose_, const uint8_t m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
