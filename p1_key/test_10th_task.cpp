...
namespace NS_10tasks {
    ...
    bool find_dominating_state_p_iterations(const state& s, mt20& visitedStates20) {
        ...
        for (mt20::iterator itr20 = visitedStates20.begin(); itr20 != visitedStates20.end(); itr20++) {
            if (itr20->first > s.p[0]) break;
                ...
                for (mt19::iterator itr19 = (itr20->second).begin(); itr19 != (itr20->second).end(); itr19++) {
                    if (itr19->first > s.p[1]) break;
                    else {
                        for (mt18::iterator itr18 = (itr19->second).begin(); itr18 != (itr19->second).end(); itr18++) {
                            if (itr18->first > s.p[2]) break;
                            else {
                                for (mt17::iterator itr17 = (itr18->second).begin(); itr17 != (itr18->second).end(); itr17++) {
                                    if (itr17->first > s.p[3]) break;
                                    else {
                                        for (mt16::iterator itr16 = (itr17->second).begin(); itr16 != (itr17->second).end(); itr16++) {
                                            if (itr16->first > s.p[4]) break;
                                            else {
                                                for (mt15::iterator itr15 = (itr16->second).begin(); itr15 != (itr16->second).end(); itr15++) {
                                                    if (itr15->first > s.p[5]) break;
                                                    else {
                                                        for (mt14::iterator itr14 = (itr15->second).begin(); itr14 != (itr15->second).end(); itr14++) {
                                                            if (itr14->first > s.p[6]) break;
                                                            else {
                                                                for (mt13::iterator itr13 = (itr14->second).begin(); itr13 != (itr14->second).end(); itr13++) {
                                                                    if (itr13->first > s.p[7]) break;
                                                                    else {
                                                                        for (mt12::iterator itr12 = (itr13->second).begin(); itr12 != (itr13->second).end(); itr12++) {
                                                                            if (itr12->first > s.p[8]) break;
                                                                            else {
                                                                                for (mt11::iterator itr11 = (itr12->second).begin(); itr11 != (itr12->second).end(); itr11++) {
                                                                                    if (itr11->first > s.p[9]) break;
    ...
    bool find_dominating_state(const state& s, mt25* visitedStates) {
        ...
        for (unsigned int i25 = 0; i25 < keysNum_pj; i25++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i25]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i25], keysNum_lj, bKeys_lj);
                
                for (unsigned int i24 = 0; i24 < keysNum_lj; i24++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i25]]).find((*bKeys_lj)[i24]) != ((*visitedStates)[(*bKeys_pj)[i25]]).end()) {
                        ...
                        for (unsigned int i23 = 0; i23 < keysNum_p1; i23++) { // p1 keys
    ...
    void remove_dominated_states(const state& s, mt25* visitedStates) {
        ...
        for (unsigned int i25 = 0; i25 < keysNum_pj2; i25++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i25]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i25], keysNum_lj2, bKeys_lj2);
                
                for (unsigned int i24 = 0; i24 < keysNum_lj2; i24++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i25]]).find((*bKeys_lj2)[i24]) != ((*visitedStates)[(*bKeys_pj2)[i25]]).end()) {
                        ...
                        for (unsigned int i23 = 0; i23 < keysNum_p1_2; i23++) { // p1 key
    ...
    void add_state_to_map(const state& s, mt25* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][s.sumCs][s.sumSlacks][s.p[0]][s.p[1]][s.p[2]][s.p[3]][s.p[4]][s.p[5]][s.p[6]][s.p[7]][s.p[8]][s.p[9]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]] = true;
    }
...
bool test_10th_task(const bool verbose_, const uint8_t m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
