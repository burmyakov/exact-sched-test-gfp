...
namespace NS_10tasks {
    ...
    void get_states_num(mt25* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        
        statesNum = 0;
        statesNum_tauKpending = 0;
        
        for (mt25::iterator itr25 = (*generated).begin(); itr25 != (*generated).end(); itr25++) {
    ...
    bool find_dominating_state(const state& s, mt25* visitedStates) {
        ...
        for (int i25 = 0; i25 < keysNum_pj; i25++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj)[i25]) != (*visitedStates).end()) {
                
                get_keys_lj(s, ts.n, (*bKeys_pj)[i25], keysNum_lj, bKeys_lj);
                
                for (int i24 = 0; i24 < keysNum_lj; i24++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj)[i25]]).find((*bKeys_lj)[i24]) != ((*visitedStates)[(*bKeys_pj)[i25]]).end()) {
                        
                        get_keys_p1(s, ts, (*bKeys_lj)[i24], keysNum_p1, bKeys_p1);
                        
                        for (int i23 = 0; i23 < keysNum_p1; i23++) { // p1 keys
                            if ((((*visitedStates)[(*bKeys_pj)[i25]])[(*bKeys_lj)[i24]]).find((*bKeys_p1)[i23]) != (((*visitedStates)[(*bKeys_pj)[i25]])[(*bKeys_lj)[i24]]).end()) {
                                
                                // sum of remaining execution times
                                for (mt22::reverse_iterator itr22 = ((((*visitedStates)[(*bKeys_pj)[i25]])[(*bKeys_lj)[i24]])[(*bKeys_p1)[i23]]).rbegin(); itr22 != ((((*visitedStates)[(*bKeys_pj)[i25]])[(*bKeys_lj)[i24]])[(*bKeys_p1)[i23]]).rend(); itr22++) {
    ...
    void remove_dominated_states(const state& s, mt25* visitedStates) {
        ...
        for (int i25 = 0; i25 < keysNum_pj2; i25++) { // pending jobs binary key
            if ((*visitedStates).find((*bKeys_pj2)[i25]) != (*visitedStates).end()) {
                
                get_keys_lj2(s, ts.n, (*bKeys_pj2)[i25], keysNum_lj2, bKeys_lj2);
                
                for (int i24 = 0; i24 < keysNum_lj2; i24++) { // locked jobs binary key
                    if (((*visitedStates)[(*bKeys_pj2)[i25]]).find((*bKeys_lj2)[i24]) != ((*visitedStates)[(*bKeys_pj2)[i25]]).end()) {
                        
                        get_keys_p1_2(s, ts, (*bKeys_lj2)[i24], keysNum_p1_2, bKeys_p1_2);
                        
                        for (int i23 = 0; i23 < keysNum_p1_2; i23++) { // p1 key
                            if (((*visitedStates)[(*bKeys_pj2)[i25]][(*bKeys_lj2)[i24]]).find((*bKeys_p1_2)[i23]) != ((*visitedStates)[(*bKeys_pj2)[i25]][(*bKeys_lj2)[i24]]).end()) {
                                
                                for (mt22::iterator itr22 = (((((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]])[(*bKeys_p1_2)[i23]])).begin(); itr22 != (((((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]])[(*bKeys_p1_2)[i23]])).end();) {
                                    ...
                                    if (itr22->first > s.sumCs) break;
                                        ...
                                        if ((itr22->second).empty()) (((((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]])[(*bKeys_p1_2)[i23]])).erase(itr22++);
                                        else ++itr22;
                                    }
                                }
                                
                                if (((((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]])[(*bKeys_p1_2)[i23]]).empty()) (((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]]).erase((*bKeys_p1_2)[i23]);
                            }
                        }
                        
                        if ((((*visitedStates)[(*bKeys_pj2)[i25]])[(*bKeys_lj2)[i24]]).empty()) ((*visitedStates)[(*bKeys_pj2)[i25]]).erase((*bKeys_lj2)[i24]);
                    }
                }
                
                if ((((*visitedStates)[(*bKeys_pj2)[i25]])).empty()) (*visitedStates).erase((*bKeys_pj2)[i25]);
            }
        }
    ...
    void add_state_to_map(const state& s, mt25* visitedStates) {
        ...
        // add state s to map
        (*visitedStates)[bs_pj][bs_lj][bs_p1][s.sumCs][s.sumSlacks][s.t[0]][s.t[1]][s.t[2]][s.t[3]][s.t[4]][s.t[5]][s.t[6]][s.t[7]][s.t[8]][s.t[9]][s.c[0]][s.c[1]][s.c[2]][s.c[3]][s.c[4]][s.c[5]][s.c[6]][s.c[7]][s.c[8]][s.c[9]] = true;
    }
    ...
    bool update_map(const state& s, mt25* visitedStates, const bool removeStates) {
...
bool test_10th_task(const bool verbose_, const unsigned short m_, const TS& ts_, const bool removeStates_, unsigned long int& savedStatesNum_, unsigned long int& visitedStatesNum_) {
    
    NS_10tasks::verbose = verbose_;
    
    bool schedulable = NS_10tasks::populate(m_, ts_, removeStates_);
