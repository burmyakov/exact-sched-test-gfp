                                                                                                                                        ...
                                                                                                                                        if (itr4->first > s.p[4]) break;
                                                                                                                                            ...
                                                                                                                                            for (mt3::reverse_iterator itr3 = (itr4->second).rbegin(); itr3 != (itr4->second).rend(); itr3++) {
                                                                                                                                                if (itr3->first < s.c[4]) break;
                                                                                                                                                    ...
                                                                                                                                                    for (mt2::iterator itr2 = (itr3->second).rbegin(); itr2 != (itr3->second).end(); itr2++) {
...
bool find_dominating_state_hpt3(const state& s, const TS& ts, mt22& visitedStates) {
    ...
    if (s.p[1] <= ts.P[1] - ts.C[1]) { // s.c[1] == 0
        for (mt24::iterator itr24 = visitedStates.begin(); itr24 != visitedStates.end(); itr24++) {
            if (itr24->first > s.p[1]) break;
                ...
                if (find_dominating_state_hpt3(s, ts, itr24->second)) return true;
            }
        }
    } else { // s.c[1] > 0
...
void add_state_to_map(const state& s, const TS& ts, mt27* visitedStates) {
    ...
    (*visitedStates)[bs_pj][s.p[0]][s.p[1]][s.p[2]][s.p[12]][s.c[12]][s.p[11]][s.c[11]][s.p[10]][s.c[10]][s.p[9]][s.c[9]][s.p[8]][s.c[8]][s.p[7]][s.c[7]][s.p[6]][s.c[6]][s.p[5]][s.c[5]][s.p[4]][s.c[4]][s.p[3]][s.c[3]] = true;
}
