...
namespace NS_7tasks {
    ...
    void get_states_num(mt21* generated, unsigned long int& statesNum, unsigned long int& statesNum_tauKpending) {
        ...
        //for (mt22::iterator itr22 = (*generated).begin(); itr22 != (*generated).end(); itr22++) {
    ...
    bool stateIsDominated(const state& s1, const state& s2) {
        int tasksNum = ts.n;
        
        for (int i=0; i<tasksNum; i++) {
            if ((s1.c[i] > s2.c[i]) || (s1.t[i] < s2.t[i])) return false;
        }
        
        // state s2 dominates state s1
        return true;
    }
    ...
    bool find_dominating_state(const state& s, mt21* visitedStates) {
        ...
        // Collect bitset keys of states,
        // which might dominate state s
                                    ...
                                    if (((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]]).find((*bKeys_p2)[i19]) != (((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]].end()) {
                                        ...
                                        for (int i18 = 0; i18 < keysNum_p3; i18++) {
                                            ...
                                            if (((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]])[(*bKeys_p2)[i19]].find((*bKeys_p3)[i18]) != (((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]][(*bKeys_p2)[i19]].end()) {
                                                ...
                                                /*get_keys_p4(s, ts, (*bKeys_lj)[i21], (*bKeys_p1)[i20], (*bKeys_p2)[i19], (*bKeys_p3)[i18], keysNum_p4, bKeys_p4);
                                                for (int i17 = 0; i17 < keysNum_p4; i17++) {
                                                    
                                                    if (((((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]])[(*bKeys_p2)[i19]][(*bKeys_p3)[i18]].find((*bKeys_p4)[i17]) != (((*visitedStates)[(*bKeys_pj)[i22]])[(*bKeys_lj)[i21]])[(*bKeys_p1)[i20]][(*bKeys_p2)[i19]][(*bKeys_p3)[i18]].end()) {*/
                                    ...
                                    if (((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]].find((*bKeys_p2_2)[i19]) != ((*visitedStates)[(*bKeys_pj2)[i22]][(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]].end()) {
                                        ...
                                        for (int i18 = 0; i18 < keysNum_p3_2; i18++) {
                                            ...
                                            if (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]])[(*bKeys_p2_2)[i19]].find((*bKeys_p3_2)[i18]) != (((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]][(*bKeys_p2_2)[i19]].end()) {
                                                ...
                                                /*get_keys_p4_2(s, ts, (*bKeys_lj2)[i21], (*bKeys_p1_2)[i20], (*bKeys_p2_2)[i19], (*bKeys_p3_2)[i18], keysNum_p4_2, bKeys_p4_2);
                                                for (int i17 = 0; i17 < keysNum_p4_2; i17++) {
                                                    
                                                    if (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]])[(*bKeys_p2_2)[i19]][(*bKeys_p3_2)[i18]].find((*bKeys_p4_2)[i17]) != (((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]][(*bKeys_p2_2)[i19]][(*bKeys_p3_2)[i18]].end()) {*/
                                                        ...
                                                        /*if (((((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]])[(*bKeys_p2_2)[i19]][(*bKeys_p3_2)[i18]][(*bKeys_p4_2)[i17]].empty()) (((*visitedStates)[(*bKeys_pj2)[i22]])[(*bKeys_lj2)[i21]])[(*bKeys_p1_2)[i20]][(*bKeys_p2_2)[i19]][(*bKeys_p3_2)[i18]].erase((*bKeys_p4_2)[i17]);
                                                    }
                                                }*/
    ...
    void add_state_to_map(const state& s, mt21* visitedStates) {
        ...
        //unsigned long int stateKey_pj = bs_pj.to_ulong();
        
        my_bitset bs_p1;
        for (unsigned short i = 0; i < ts.n; i++) if (s.t[i] > ((float)(ts.T[i]))/2) bs_p1.set(i, 1); else bs_p1.set(i, 0);
        //unsigned long int stateKey_p1 = bs_p1.to_ulong();
        ...
        /*my_bitset bs_p4;
        for (unsigned short i = 0; i < ts.n; i++) {
            if ((s.t[i] <= ((float)(ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(2*ts.T[i]))/16)&&(s.t[i] <= ((float)(3*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(4*ts.T[i]))/16)&&(s.t[i] <= ((float)(5*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(6*ts.T[i]))/16)&&(s.t[i] <= ((float)(7*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(8*ts.T[i]))/16)&&(s.t[i] <= ((float)(9*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(10*ts.T[i]))/16)&&(s.t[i] <= ((float)(11*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(12*ts.T[i]))/16)&&(s.t[i] <= ((float)(13*ts.T[i]))/16)) bs_p3.set(i, 0);
            else if ((s.t[i] > ((float)(14*ts.T[i]))/16)&&(s.t[i] <= ((float)(15*ts.T[i]))/16)) bs_p3.set(i, 0);
            else bs_p3.set(i, 1);
        }*/
        
        my_bitset bs_lj;
        for (unsigned short i = 0; i < ts.n; i++) if (s.t[i] > 0) bs_lj.set(i, 1); else bs_lj.set(i, 0);
        //unsigned long int stateKey_lj = bs_lj.to_ulong();
    ...
    void init() {
        ...
        //bKeys_p4 = new vector<my_bitset>(pow(2.0, ts.n));
        ...
        //bKeys_p4_2 = new vector<my_bitset>(pow(2.0, ts.n));
        bKeys_lj2 = new vector<my_bitset>(pow(2.0, ts.n));
        
        /*keys_pj = new vector<unsigned int>(pow(2.0, ts.n));
        keys_p1 = new vector<unsigned int>(pow(2.0, ts.n));
        keys_lj = new vector<unsigned int>(pow(2.0, ts.n));
        keys_pj2 = new vector<unsigned int>(pow(2.0, ts.n));
        keys_p1_2 = new vector<unsigned int>(pow(2.0, ts.n));
        keys_lj2 = new vector<unsigned int>(pow(2.0, ts.n));*/
